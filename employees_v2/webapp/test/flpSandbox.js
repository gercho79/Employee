		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#logaligroupemployeesv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupemployeesv2-display": {
								"semanticObject": "logaligroupemployeesv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.employeesv2",
									"url": sap.ui.require.toUrl("logaligroup/employeesv2")
								}
							}
						}
					}
